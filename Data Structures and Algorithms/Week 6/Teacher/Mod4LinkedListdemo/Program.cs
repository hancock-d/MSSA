namespace Mod4LinkedListdemo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (lList.Search(3, out found)) //out parameter contains index
            {
            ...
            lList.AddAnywhere(2, 2); //adding data #2 at position 2
            lList.AddAnywhere(0, 1); //adding data #0 to position 1
            lList.Display();

            lList.RemoveAnywhere(2); //removes position number 2
            lList.Display();
